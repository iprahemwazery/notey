...
import 'package:notey/features/onboarding/data/repositories_impl/onboarding_repository.dart';
import 'package:notey/features/onboarding/domain/repositories/onboarding_repository.dart';
import 'package:notey/features/onboarding/domain/usecases/complete_onboarding.dart';

import 'package:notey/l10n/generated/app_localizations.dart';

/// First-run welcome carousel. Shown once, before the lock-method setup.
class OnboardingScreen extends StatefulWidget {
  const OnboardingScreen({super.key, required this.onDone, this.repository});

  /// Called after onboarding is completed (skipped or finished).
...
class _OnboardingScreenState extends State<OnboardingScreen> {
  ...
  late final OnboardingRepository _repository =
      widget.repository ?? OnboardingRepositoryImpl();
  int _page = 0;
  ...
  Future<void> _finish() async {
    await Haptics.light();
    await CompleteOnboarding(_repository)();
    widget.onDone();
  }
