...
import 'package:notey/features/auth/presentation/widgets/backup_pin_setup_view.dart'
    show BackupPinSetupView;
import 'package:notey/features/auth/presentation/widgets/biometric_offer_view.dart'
    show BiometricOfferView;
import 'package:notey/features/auth/presentation/widgets/choosing_view.dart'
    show ChoosingView;
import 'package:notey/features/auth/presentation/widgets/device_setup_view.dart';
import 'package:notey/features/auth/presentation/widgets/pin_setup_view.dart';
    ...
    Navigator.of(context).pushReplacement(
      MaterialPageRoute<void>(
        builder: (_) => BlocProvider<HomeCubit>(
          create: (_) => HomeCubit(repository ?? NoteRepositoryImpl()),
          child: HomeScreen(
            repository: repository,
            lockController: controller,
            biometricService: biometricService,
